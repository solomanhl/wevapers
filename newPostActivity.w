...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="left:18px;width:227px;height:auto;top:172px;"><div component="$UI/system/components/justep/data/baasData" autoLoad="true" xid="pre_common_member" queryAction="queryPre_common_member" saveAction="savePre_common_member" url="/wevapers/wevapers" tableName="pre_common_member" idColumn="uid"><column label="uid" name="uid" type="Integer" xid="default24"></column>
  ...
  <div component="$UI/system/components/justep/data/baasData" autoLoad="true" xid="pre_forum_post" queryAction="queryPre_forum_post" saveAction="savePre_forum_post" url="/wevapers/wevapers" tableName="pre_forum_post" idColumn="position"><column label="pid" name="pid" type="Integer" xid="default75"></column>
  ...
  <div component="$UI/system/components/justep/data/baasData" autoLoad="true" xid="pre_forum_forum" queryAction="queryPre_forum_forum" saveAction="savePre_forum_forum" url="/wevapers/wevapers" limit="-1" idColumn="fid" tableName="pre_forum_forum"><column label="fid" name="fid" type="Integer" xid="default72"></column>
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
      ...
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar"> 
        ...
        <div class="x-titlebar-title">
          <div xid="div_title" bind-click="div_titleClick">
            <label xid="label_title"><![CDATA[选择版块，右边的image是上下箭头]]></label>
            <img src="" alt="" xid="image_title"/>
          </div>
        </div>  
    ...
    <div class="x-panel-content" xid="content1">
      <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
        xid="panel_txt"> 
        <div component="$UI/system/components/justep/popOver/popOver" class="x-popOver" direction="auto" xid="popOver1" anchor="top_txtTitle" position="center">
   <div class="x-popOver-overlay" xid="div1"></div>
   <div class="x-popOver-content" xid="div2"><div component="$UI/system/components/justep/list/list" class="x-list" xid="list1" autoLoad="true" data="pre_forum_forum">
   <ul class="x-list-template" xid="listTemplateUl1">
    <li xid="li1" bind-click="li1Click"><label xid="label_selectForum" bind-text='val("name")'><![CDATA[]]></label></li></ul> </div></div></div><div class="x-panel-top" xid="top_txtTitle">
          <input component="$UI/system/components/justep/input/input" class="form-control"
            xid="input_title" placeHolder="标题"/>
        </div>  
        <div class="x-panel-content" xid="content_txt">
          <input component="$UI/system/components/justep/input/input" class="form-control"
            xid="input_txt" placeHolder="说点什么吧......"/>
        </div>  
        <div class="x-panel-bottom" xid="bottom_txt">
          <a component="$UI/system/components/justep/button/button" class="btn btn-default"
